 ...
 * Получает параметры через GET: calc_id, client_id
 */
				...
				<div class="thanx-container">
					<div class="img">
						<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M9 18.0007L15.364 24.3647L28.0905 11.6367" stroke="#2C619D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
						</svg>
					</div>
					<div class="title">
						<h1>Спасибо!</h1>
					...
					<div class="text">
						<?php if ($calc_id): ?>
							Заказ № <?php echo $calc_id; ?> создан, в ближайшее время менеджер свяжется с вами для уточнения подробностей
						<?php else: ?>
