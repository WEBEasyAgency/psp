<template>
    <div class="calculator">
        <h1 class="calculator__title">Акриловые таблички</h1>
                ...
                <div class="calculator__services">
                    <div class="calculator__services-header">
                        ...
                        <HelpPopover
                            ...
                            description="Выберите дополнительные опции для вашей акриловой таблички: скотч для крепления, отверстия для монтажа, скругленные углы или двусторонняя печать."
                        />
                    </div>
                    <div class="calculator__services-list">
                        ...
                        <ToggleSwitch
                            ...
                            help-description="Сверление отверстий диаметром 5мм в углах таблички для крепления на саморезы или дистанционные держатели."
                        />
                        <ToggleSwitch
                            v-model="calculatorData.round"
                            label="Скругление углов"
                            help-title="Скругление углов"
                            help-description="Скругление острых углов акрила радиусом 10мм. Придает законченный вид и повышает безопасность."
                        />
                        <ToggleSwitch
                            v-model="calculatorData.doubleside"
                            label="Изображение с двух сторон"
                            help-title="Изображение с двух сторон"
                            help-description="Полноцветная УФ-печать с обеих сторон акриловой таблички. Идеально для подвесных конструкций."
                        />
                    </div>
                </div>
...
const calculatorDataForCart = computed(() => {
    return {
        params: [
            ...
            {variable: 'th_acryl', type: 5, value: calculatorData.th_acryl},
