                    ...
                    <div class="catalog-menu">
                        <ul>
                            ...
                            <li class="parent">
                                ...
                                <div class="child">
                                    <ul>
                                        <li class="li"><a class="disabled">Баннер с люверсами (скоро)</a></li>
                                        <li class="li"><a class="disabled">Баннер на раме (скоро)</a></li>
                                    </ul>
                                </div>
                            </li>
...
<script setup>
// Минимальный скрипт - пусть jQuery из app.min.js обрабатывает всё меню
</script>
