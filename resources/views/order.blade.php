                    ...
                    <div class="left-block">
                        <div class="design-price">
                            ...
                            <div id="fileUploadSection">
                                <label class="file">
                                    ...
                                    <span class="btn">
											<svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
												<path d="M4 8H8M8 8H12M8 8V12M8 8V4" stroke="#F6F6F6" stroke-width="1.5"
                                ...
                                <div class="file-info"
                                     style="margin-top: 12px; padding: 12px; background-color: #f8fafc; border-radius: 8px; border: 1px solid #e2e8f0;">
                                    <div style="color: #64748b; font-size: 13px; line-height: 1.6;">
                                        <div style="font-weight: 500; color: #475569; margin-bottom: 6px;">Допустимые
                                            форматы:
                                        </div>
                                        <div>• Графические: JPG, PNG, GIF, BMP, SVG, WebP</div>
                                        <div>• Векторные: AI, EPS, PDF, CDR</div>
                                        <div>• Архивы: ZIP, RAR</div>
                                        <div style="margin-top: 8px;"><strong>Максимальный размер файла:</strong> 50 МБ
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="all-price">
                                ...
                                <div class="val"
                                     id="totalPrice">{{ $from_cart ? '0' : number_format($price_good, 0, ',', ' ') }} ₽
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="right-block">
                        ...
                        <form class="form-block" id="orderForm">
                            ...
                            <div class="form-field required">
                                ...
                                <div class="field"><input type="text" name="fio" required="required"
                                                          placeholder="Как вас зовут?"></div>
                            </div>
                            <div class="form-field required">
                                <div class="caption">Телефон для связи</div>
                                <div class="field"><input type="tel" name="phone" required="required"
                                                          placeholder="+7 (___) ___-__-__"></div>
                            </div>
                            <div class="form-field required">
                                <div class="caption">E-mail</div>
                                <div class="field"><input type="email" name="email" required="required"
                            ...
                            <div class="check-field">
                                <label class="checkbox">
                                    ...
                                    <span class="check"></span>
                                    <span class="label">Я даю согласие на обработку моих персональных данных ИП Лыков П.С. (ИНН 631921444166) в целях обработки заявки и обратной связи. Политика конфиденциальности — по <a
                                            href="https://ra-psp.ru/policy/" target="_blank">ссылке</a>, политику обработки персональных данных — по <a
                                            href="https://ra-psp.ru/politika-v-otnoshenii-obrabotki-personalnyh-dannyh/"
                            ...
                            <div class="btn-block">
                                <a href="javascript:history.back()" class="back">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path d="M18 18L12 12M12 12L6 6M12 12L18 6M12 12L6 18" stroke="#2C619D"
                            ...
                            <!-- Блок сообщений -->
                            <div id="orderMessage"
                                 style="display: none; margin-top: 20px; padding: 15px; border-radius: 8px;"></div>
                        </form>
                    </div>
                </div>
            </div>
