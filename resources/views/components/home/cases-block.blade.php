    ...
    <div class="container">
        ...
        <div class="tabs-body">
            ...
            <div class="tab active" id="case1">
                <div class="cases-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1а Объемные буквы с бортом из алюминия/51591256683_b86fa76966_o.jpg" alt="Объемные буквы с бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1а Объемные буквы с бортом из алюминия/52335886553_c53ca905ff_o.jpg" alt="Объемные буквы с бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1а Объемные буквы с бортом из алюминия/53164874242_2027525c8f_o.jpg" alt="Объемные буквы с бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1а Объемные буквы с бортом из алюминия/53583983199_5993b94b19_o.jpg" alt="Объемные буквы с бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1а Объемные буквы с бортом из алюминия/53872998582_67ff714deb_o.jpg" alt="Объемные буквы с бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1а Объемные буквы с бортом из алюминия/54082481788_c092dd86a4_o.jpg" alt="Объемные буквы с бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1а Объемные буквы с бортом из алюминия/54165489172_4eb95e8292_o.jpg" alt="Объемные буквы с бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1а Объемные буквы с бортом из алюминия/54453498797_5f913e4bbe_o.jpg" alt="Объемные буквы с бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1а Объемные буквы с бортом из алюминия/54817356041_729506fbe6_o.jpg" alt="Объемные буквы с бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1а Объемные буквы с бортом из алюминия/54817614968_3158408d0d_o.jpg" alt="Объемные буквы с бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1а Объемные буквы с бортом из алюминия/54899527284_574c304725_o.jpg" alt="Объемные буквы с бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1б Объемные буквы со световым бортом/37219092276_ba32f03104_o.jpg" alt="Объемные буквы со световым бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1б Объемные буквы со световым бортом/40781643113_5bfb940059_o.jpg" alt="Объемные буквы со световым бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1б Объемные буквы со световым бортом/46056655865_4e010fa4fc_o.jpg" alt="Объемные буквы со световым бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1б Объемные буквы со световым бортом/49050509037_f9b7e56eea_o.jpg" alt="Объемные буквы со световым бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1б Объемные буквы со световым бортом/49474383027_3d8d141632_o.jpg" alt="Объемные буквы со световым бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1б Объемные буквы со световым бортом/52593568281_75cf5f345e_o.jpg" alt="Объемные буквы со световым бортом"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/1б Объемные буквы со световым бортом/53581004199_d151bdb075_o.jpg" alt="Объемные буквы со световым бортом"></div></div>
                    </div>
                </div>
            </div>
            <!-- case2: Вывески -->
            <div class="tab" id="case2">
                <div class="cases-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/2а Пластиковые вывески/23089148345_167d80903d_o.jpg" alt="Пластиковая вывеска"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/2а Пластиковые вывески/49114475772_c42c47a558_o.jpg" alt="Пластиковая вывеска"></div></div>
            ...
            <div class="tab" id="case7">
                <div class="cases-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7а Режим работы акриловый Премиум/33753684118_eeb280a079_o.jpg" alt="Режим работы акриловый премиум"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7а Режим работы акриловый Премиум/47695373262_10af4c12cb_4k.jpg" alt="Режим работы акриловый премиум"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7а Режим работы акриловый Премиум/48622826311_71aa6af4eb_o.jpg" alt="Режим работы акриловый премиум"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7а Режим работы акриловый Премиум/50272135681_f6a900f441_o.jpg" alt="Режим работы акриловый премиум"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7а Режим работы акриловый Премиум/52552891900_7510d90329_o.jpg" alt="Режим работы акриловый премиум"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7а Режим работы акриловый Премиум/52605843147_0317547e76_o.jpg" alt="Режим работы акриловый премиум"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7а Режим работы акриловый Премиум/52907018633_ff39cf7d00_o.jpg" alt="Режим работы акриловый премиум"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7б Режим работы пластиковый/33094817628_dc61a243d9_o.jpg" alt="Режим работы пластиковый"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7б Режим работы пластиковый/40538837443_e04293f217_o.jpg" alt="Режим работы пластиковый"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7б Режим работы пластиковый/43513142481_92739e690a_o.jpg" alt="Режим работы пластиковый"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7б Режим работы пластиковый/48151794776_a294ac1cf9_o.jpg" alt="Режим работы пластиковый"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7б Режим работы пластиковый/48623040192_cf507bbe1c_4k.jpg" alt="Режим работы пластиковый"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7б Режим работы пластиковый/50273977268_b26c4458bf_o.jpg" alt="Режим работы пластиковый"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7б Режим работы пластиковый/52940047253_ef9c9b43e8_4k.jpg" alt="Режим работы пластиковый"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7в Режим работы (наклейка)/44460785652_19a1b9e42e_o.jpg" alt="Режим работы наклейка"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7в Режим работы (наклейка)/47630996521_6072ce7a77_o.jpg" alt="Режим работы наклейка"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7в Режим работы (наклейка)/52037701411_87e08e47ae_o.jpg" alt="Режим работы наклейка"></div></div>
                        <div class="swiper-slide"><div class="img"><img src="/img/Контент/Контент/7в Режим работы (наклейка)/52276938775_afbefdff17_o.jpg" alt="Режим работы наклейка"></div></div>
                    </div>
                </div>
            </div>
        </div>
